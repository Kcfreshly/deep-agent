...
## [0.3.7](https://github.com/Kcfreshly/deep-agent/compare/langchain-quickjs==0.3.6...langchain-quickjs==0.3.7) (2026-09-18)


### Features

* **quickjs:** add hmac check to snapshot bytes ([#5601](https://github.com/Kcfreshly/deep-agent/issues/5601)) ([749b386](https://github.com/Kcfreshly/deep-agent/commit/749b386f97ed7b920acfd5936b01f8c425976d92))
